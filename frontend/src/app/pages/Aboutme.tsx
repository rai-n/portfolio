        ...
        <div className="flex">
            <div id="about" className="bg-[#2E3E51] min-h-screen p-8 pt-40 lg:w-full xl:w-6/6">
                ...
                <p className="text-center text-white text-xl max-w-3xl mx-auto pt-20 mb-20">
                    <span className="font-bold text-yellow-400 glow">Experienced</span> <span className="font-bold text-green-400 glow">Full Stack Developer</span> passionate about <span className="font-bold text-purple-400 glow">cloud development</span>. Skilled in <span className="font-bold text-blue-400 glow">React/React Native</span> and <span className="font-bold text-blue-400 glow"> Typescript</span> with expertise in <span className="font-bold text-orange-400 glow">accessibility</span>.
                    <br /><br />
